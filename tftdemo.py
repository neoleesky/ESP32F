...
tft.init(tft.ST7735R, speed=10000000, spihost=tft.HSPI, mosi=23, miso=19, clk=18, cs=26, dc=17, rst_pin=16, backl_pin=13, hastouch=False, bgr=False, width=128, height=128, backl_on=1)
...
tft.text(x, y, "aaaa/", machine.random(0xFFFFFF))
